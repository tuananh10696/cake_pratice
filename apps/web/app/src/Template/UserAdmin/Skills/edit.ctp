...
<div class="title_area">
  ...
  <div class="pankuzu">
    <ul>
      ...
      <li><a
          href="<?= $this->Url->build(['action' => 'index']); ?>">スキル</a>
      </li>
    ...
    <div class="table_area form_area">
      ...
      <table class="vertical_table table__meta">
        ...
        <tr>
          <td>カテゴリ</td>
          <td>
            <?= $this->Form->input('skill_category_id', ['type' => 'select', 'options' => $category_list]); ?>
          </td>
        </tr>

        <tr>
          <td>スキル名<span class="attent">※必須</span></td>
          <td>
        ...
        <tr>
          <td>内容</td>
          <td>
            <?= $this->Form->input('content', ['type' => 'textarea', 'maxlength' => '1000', 'id' => 'idContent']); ?>
            <br><span>※1000文字以内で入力してください</span>
          </td>
        </tr>
