<tr id="append_block-<?= $append['slug'] ?>">
    ...
    <td>
        ...
        <?= $this->Form->input("info_append_items.{$num}.value_date", ['type' => 'hidden', 'value' => '0000-00-00']);?>
        ...
        <?= $this->Form->input("info_append_items.{$num}.value_datetime", ['type' => 'text', 'class' => 'datetimepicker', 'placeholder' => h($append['value_placeholder'] ?? ''), 'default' => empty($append['value_default']) ? '' : h($append['value_default'])]); ?>
