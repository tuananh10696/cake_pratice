<tr id="append_block-<?= $append['slug'] ?>">
    ...
    <td>
        ...
        <?= $this->Form->input("info_append_items.{$num}.value_date", ['type' => 'text', 'class' => 'datepicker', 'placeholder' => h($append['value_placeholder'] ?? ''), 'default' => empty($append['value_default']) ? '' : h($append['value_default'])]); ?>
