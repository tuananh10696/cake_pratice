  ...
  <td colspan="2">
    <div class="sub-unit__wrap">
      ...
      <dl style="border:1px solid #cbcbcb;padding: 10px;">
        ...
        <dt style="margin-top: 10px;">３．キャプション
          <?= $this->Form->input("info_contents.{$rownum}.title", ['type' => 'text', 'style' => 'width: 100%;', 'maxlength' => 100, ]); ?>
          </dt>
        <dd>
          <div>※１００文字以内</div>
        </dd>
        ...
        <dd>
          <div
            class="font_target <?= h($content['option_value']); ?> <?= $content['option_value2']; ?>">
